...
FOLDER_NAME = 'ICEWS0515_INTERPOLATION'
...
sparse_rel = []
background_rel = []
upper = 500 # max number of occurrence of sparse relation
lower = 50 # min number of occurrence of sparse relation
...
def rel_count():
    quadrupleList = []
    max_time = 0
    data = json.load(open('quadruples0515_noinv_name', ))
    for line in data:
        head = line[0]
        tail = line[2]
        rel = line[1]
